package net.umaass_providers.app.utils.permission;
...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(UtilsLib.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                 intent.resolveActivity(UtilsLib.getApp().getPackageManager()) == null ||
                 UtilsLib.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = UtilsLib.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(UtilsLib.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(UtilsLib.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(UtilsLib.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(UtilsLib.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Intent intent) {
        startActivity(intent, UtilsLib.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivity(@NonNull final Intent intent,
                                     @NonNull final Bundle options) {
        startActivity(intent, UtilsLib.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, UtilsLib.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, UtilsLib.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return UtilsLib.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(UtilsLib.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        ...
        PackageManager pm = UtilsLib.getApp().getPackageManager();
    ...
    public static Activity getTopActivity() {
        return UtilsLib.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = UtilsLib.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = UtilsLib.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(UtilsLib.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(UtilsLib.getApp(), clz));
    }
