...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(UtilsLib.getApp().getPackageName());
    }
     ...
     *
     * @param permissionsGroups The permissionsGroups.
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isGrantedGroup(final String... permissionsGroups) {
        for (String group : permissionsGroups) {
            if (!isGranted(PermissionConstants.getPermissions(group))) {
                return false;
            }
        }
        return true;
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
               || PackageManager.PERMISSION_GRANTED
                  == ContextCompat.checkSelfPermission(UtilsLib.getApp(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + UtilsLib.getApp().getPackageName()));
        UtilsLib.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public PermissionUtils(final String... permissions) {
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(UtilsLib.getApp());
    }
