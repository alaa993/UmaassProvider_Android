...
public class LayoutHelper {
    ...
    public static FrameLayout.LayoutParams createFrameWithPix(int width, int height, int gravity, float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
    ...
    public static FrameLayout.LayoutParams createFrameWithPix(int width, int height, int gravity) {
