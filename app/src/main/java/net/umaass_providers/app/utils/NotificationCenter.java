...
package net.umaass_providers.app.utils;
...
public class NotificationCenter {
    ...
    public static final int StartLocation = totalEvents++;
    public static final int GPSEnable = totalEvents++;
    public static final int GPSDisable = totalEvents++;
    public static final int StopLocation = totalEvents++;
    public static final int ChangeLocation = totalEvents++;
    public static final int LocationFail = totalEvents++;
    public static final int UpdateAppointment = totalEvents++;
    ...
    public void postNotificationNameInternal(int id, boolean allowDuringAnimation, Object... args) {
        ...
        if (!allowDuringAnimation && animationInProgress) {
            ...
            if (G.DEBUG) {
                G.log("tmessages", "delay post notification " + id + " with argsForFragments count = " + args.length);
            }
            return;
        }
        broadcasting++;
