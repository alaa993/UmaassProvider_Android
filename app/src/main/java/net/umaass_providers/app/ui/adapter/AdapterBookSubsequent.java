...
public class AdapterBookSubsequent extends RecyclerView.Adapter<AdapterBookSubsequent.MyViewHolder> {
    ...
    public AdapterBookSubsequent() {
    }

    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_book_subsequent, parent, false);
